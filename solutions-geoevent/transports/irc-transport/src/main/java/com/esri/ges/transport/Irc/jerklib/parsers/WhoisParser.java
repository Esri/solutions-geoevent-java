...
import com.esri.ges.transport.Irc.jerklib.events.impl.WhoisEventImpl;
...
public class WhoisParser implements CommandParser
{
	...
	public IRCEvent createEvent(EventToken token, IRCEvent event)
	{
		switch (token.numeric())
		{
			...
			{
				// "<nick> :{[@|+]<channel><space>}"
				// :kubrick.freenode.net 319 scripy mohadib :@#com.esri.ges.transport.Irc.jerklib
				// kubrick.freenode.net 319 scripy mohadib :@#com.esri.ges.transport.Irc.jerklib ##swing
				if (we != null )
				{
