...
import com.esri.ges.transport.Irc.jerklib.events.WhowasEvent;
...
public class WhowasEventImpl implements WhowasEvent
{
	...
	/* (non-Javadoc)
	 * @see com.esri.ges.transport.Irc.jerklib.events.WhowasEvent#getHostName()
	 */
	...
	/* (non-Javadoc)
	 * @see com.esri.ges.transport.Irc.jerklib.events.WhowasEvent#getNick()
	 */
	...
	/* (non-Javadoc)
	 * @see com.esri.ges.transport.Irc.jerklib.events.WhowasEvent#getRealName()
	 */
	...
	/* (non-Javadoc)
	 * @see com.esri.ges.transport.Irc.jerklib.events.WhowasEvent#getUserName()
	 */
