package com.esri.ges.transport.Irc.jerklib.util;
...
import com.esri.ges.transport.Irc.jerklib.events.modes.ModeEvent;
...
<pre> 		
		...
		(
			...
			session, //session
			Arrays.asList("#com.esri.ges.transport.Irc.jerklib" , "##swing") // list of channels to join on success
		);
 ...
 * 
 * 
 * @see Session#onEvent(com.esri.ges.transport.Irc.jerklib.tasks.Task, com.esri.ges.transport.Irc.jerklib.events.IRCEvent.Type...)
 * @see Type
 * @author mohadib
 *
 */
